...
export const CATEGORY_MAP: Record<number, { label: string; color: string; icon: any }> = {
  ...
  2: { label: "Environmental", color: "bg-green-500/20 text-green-400 text-sm", icon: Globe2 },
  3: { label: "Education", color: "bg-yellow-500/20 text-yellow-400 text-sm", icon: AlertTriangle },
  4: { label: "Health", color: "bg-pink-500/20 text-pink-400 text-sm", icon: HeartHandshake },
  5: { label: "Human Rights", color: "bg-purple-500/20 text-purple-400 text-sm", icon: AlertTriangle },
  6: { label: "Animal Rights", color: "bg-orange-500/20 text-orange-400 text-sm", icon: AlertTriangle },
  7: { label: "Economic", color: "bg-cyan-500/20 text-cyan-400 text-sm", icon: Globe2 },
  8: { label: "Technology", color: "bg-indigo-500/20 text-indigo-400 text-sm", icon: Globe2 },
  9: { label: "Other", color: "bg-gray-500/20 text-gray-300 text-sm", icon: Globe2 },
};
